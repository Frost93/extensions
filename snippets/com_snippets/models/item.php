...
class SnippetsModelItem extends JModelAdmin
{
	...
	public function save($data)
	{
		...
		if ($input->get('task') == 'save2copy')
		{
			...
			for ($i = 0; $i < 10; $i++)
			{
				$data['name']  = RLString::increment($data['name']);
				$data['alias'] = RLString::increment($data['alias'], 'dash');
	...
	public function copy($id)
	{
		...
		for ($i = 0; $i < 10; $i++)
		{
			$item->name  = RLString::increment($item->name);
			$item->alias = RLString::increment($item->alias, 'dash');
