...
/**
 * System Plugin that places a Conditional Content code block into the text
 */
class PlgSystemConditionalContent extends JPlugin
{
	private $_alias       = 'conditionalcontent';
	private $_title       = 'CONDITIONAL_CONTENT';
	private $_lang_prefix = 'COC';
