...
class PlgSystemSlidersHelperHead
{
	...
	public function addHeadStuff()
	{
		...
		RLFunctions::script('sliders/script.min.js', ($this->params->media_versioning ? '6.0.0' : false));

		if ($this->params->load_stylesheet)
		{
				RLFunctions::stylesheet('sliders/style.min.css', ($this->params->media_versioning ? '6.0.0' : false));
		}
