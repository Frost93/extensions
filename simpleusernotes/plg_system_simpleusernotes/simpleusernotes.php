 ...
 */
class PlgSystemSimpleUserNotes extends JPlugin
{
	private $_alias       = 'simpleusernotes';
	private $_title       = 'SIMPLE_USER_NOTES';
	...
	public function onContentPrepareForm($form, $data)
	{
		...
		return $this->_helper->addFieldToUserForm($form);
	}

	/*
	 * Remove links to core user notes
	 */
	public function onAfterRender()
	{
		...
		if (!$this->_helper->params->remove_core_links)
		{
			return;
		}

		$this->_helper->removeCoreUserNoteLinks();
	}
